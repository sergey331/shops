    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text"><span class="text-black fw-bold">{{ auth()->user()->username }}</span></h1>
            </li>
        </ul>
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
                @include('Component.Layout.Notification.notification')
            </li>
            <li class="nav-item dropdown">
...
<script src="{{public_path('/assets/js/admin/notification.js')}}"></script>