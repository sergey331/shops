    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="/admin/discounts">Discounts</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/admin/sliders">
                <i class="menu-icon mdi mdi mdi-tune-variant"></i>
                <span class="menu-title">Sliders</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/admin/about">
                <i class="menu-icon mdi mdi mdi-information"></i>
