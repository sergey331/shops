...
<div class="form-wrapper">
    ...
    <form action="/admin/sliders/{{ $slider->id}}" method="POST" enctype="multipart/form-data" class="form-grid">
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <textarea name="content" id="content" rows="3" >{{ $slider->content }}</textarea>
