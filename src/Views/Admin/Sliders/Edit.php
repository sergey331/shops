...
<div class="card">
    <div class="card-body">
        ...
        <form action="/admin/sliders/{{ $slider->id}}" method="POST" enctype="multipart/form-data" class="form-sample">
            ...
            <div class="form-group">
                ...
                <textarea name="content" class="form-control" id="content" rows="3" >{{ $slider->content }}</textarea>
            ...
            <div class="form-check form-check-flat form-check-primary " style="margin-left: 24px">
                <label for="form-check-label">
                    <input type="checkbox" name="is_show" class="form-check-input" id="is_show"  value="1" {{ $slider->is_show ? 'checked' : '' }}>
                    Show
                </label>
