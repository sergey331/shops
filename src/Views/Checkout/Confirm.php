<div class=" mx-auto bg-white shadow-lg rounded-xl p-6">
    ...
    <div class="mt-8 border-t pt-6 space-y-3 text-sm">
        ...
        <div class="flex justify-between w-[100%] max-w-[300px] ml-auto">
        ...
        <div class="flex justify-between text-lg font-semibold border-t pt-4 w-[100%] max-w-[300px] ml-auto">
            <span>Total</span>
