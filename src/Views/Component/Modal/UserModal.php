            ...
            <div class="tabs-listing">
                @auth
                    <ul class="flex flex-col gap-2">
                        @if($auth->isAdmin())
                            <li class="w-full p-2 text-center hover:bg-gray-300 bg-gray-100"><a href="/admin" class="w-full block">Dashboard</a></li>
                        @endif
                        <li class="w-full p-2 text-center hover:bg-gray-300 bg-gray-100"><a href="/logout" class="w-full block">Logout</a></li>
                    </ul>
                @else
                        ...
                        <div x-show="activeTab === 'register'">
                            ...
                            <form action="/register" method="POST"  class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700
                   dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Test User" required>
                                </div>
                                <!-- Email -->
                                <div>
                                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
