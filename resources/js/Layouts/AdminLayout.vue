                ...
                <li>
                    <button type="button"
                        ...
                        <svg
                            ...
                            width="24px" height="24px" viewBox="0 0 362.051 362.051"
                            xml:space="preserve">
                            <g>
                                <g>
                                    <path
                                        d="M39.697,136.466l90.905,65.659c0,0-11.219-52.193-39.845-107.182C90.764,94.943,46.432,116.262,39.697,136.466z"/>
                    ...
                    <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                        <li>
                            <a
                                ...
                                class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Categories</a>
                            <a href="#"
